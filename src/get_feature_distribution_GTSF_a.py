...
def compute_distributions(processed_path, num_bins=50):
    ...
    for data in tqdm(load_data_from_scenario_folders(processed_path)):
        ...
        print(f'y_cummulative: {data.y_cummulative}')
        #print(f'y_cummulative: {data.y_cummulative[-1]}')
...
if __name__ == "__main__":
    ...
    plt.savefig(os.path.join(save_dir, f'{NAME}y_cumulative_distribution.png'))
    plt.clf()
