...
ax1.set_xlabel("Active Power injection [GW]")
...
ax2.set_xlabel("Reactive Power injction [MVAr]")
...
#Node Features (gen features)
fig17,ax17=plt.subplots()
ax17.bar(x_bins[8],x_hists[8],width=x_bins[8,1]-x_bins[8,0],align='edge', color='turquoise')
#ax2.set_title("Node Feature Voltage magnitude")
...
ax18.bar(x_bins[9],x_hists[9],width=x_bins[9,1]-x_bins[9,0],align='edge', color='turquoise')
#ax2.set_title("Node Feature Voltage magnitude")
...
ax19.bar(x_bins[10],x_hists[10],width=x_bins[10,1]-x_bins[10,0],align='edge', color='turquoise')
#ax2.set_title("Node Feature Voltage magnitude")
...
ax20.bar(x_bins[11],x_hists[11],width=x_bins[11,1]-x_bins[11,0],align='edge', color='turquoise')
#ax2.set_title("Node Feature Voltage magnitude")
...
ax21.bar(x_bins[13]/10,x_hists[13],width=(x_bins[13,1]-x_bins[13,0])/10,align='edge', color='turquoise')
#ax2.set_title("Node Feature Voltage magnitude")
...
ax22.bar(x_bins[14]/10,x_hists[14],width=(x_bins[14,1]-x_bins[14,0])/10,align='edge', color='turquoise')
#ax2.set_title("Node Feature Voltage magnitude")
