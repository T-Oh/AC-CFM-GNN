...
2. **Initial processing (creates unnormalized processed data)**  
    You can choose any of the defined data types (except `"LSTM"`, `"LDTSF"` and `"LDTSF_DC"`) the *Direct Prediction* data types are explained in *Thesis.pdf*. It is recommended to use `"ZHU"`
